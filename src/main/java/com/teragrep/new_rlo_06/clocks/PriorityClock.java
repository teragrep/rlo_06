...
public class PriorityClock implements Clock<Priority> {
    ...
    private final PriorityOpenClock priorityOpenClock;
    private final PriorityNumbersClock priorityNumbersClock;
    private final PriorityCloseClock priorityCloseClock;
    private final Function<ByteBuffer, ByteBuffer> priorityClocks;

    public PriorityClock() {
        this.priorityOpenClock = new PriorityOpenClock();
        this.priorityNumbersClock = new PriorityNumbersClock();
        this.priorityCloseClock = new PriorityCloseClock();

        this.priorityClocks = priorityOpenClock.andThen(priorityNumbersClock.andThen(priorityCloseClock));
    ...
    public Priority get() {
        ...
        if (priorityCloseClock.isComplete()) {
            ...
            List<ByteBuffer> numbersBuffers = priorityNumbersClock.get();
