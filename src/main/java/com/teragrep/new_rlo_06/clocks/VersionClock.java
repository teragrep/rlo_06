...
public class VersionClock implements Clock<Version> {
    ...
    public VersionClock(Consumer<ByteBuffer> nextClock) {
        this.spaceClock = new CharClock(nextClock, ' ');
        this.numberSequenceClock = new NumberSequenceClock(this.spaceClock, 1);
    }

    @Override
    public void accept(ByteBuffer byteBuffer) {
        numberSequenceClock.accept(byteBuffer);
    }
    ...
    public Version get() {
        ...
        return new VersionBufferedImpl(numbers, spaces);
    }
